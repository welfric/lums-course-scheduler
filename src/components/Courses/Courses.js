          ...
          {courseData.nodes
            .filter(
              (course) =>
                ...
                course.Course_Title.toUpperCase().match(searchCourse) ||
                course.Course_Code.toUpperCase().match(searchCourse) ||
                course.Instructor.toUpperCase().match(searchCourse)
            )
              ...
              <li key={course.id}>
                ...
                <div style={{}} className="buttu">
                  <img
                    ...
                    onClick={(e) => onAdd(e.target.className, course.Cr_Hrs)}
                  />
                </div>
              </li>
            ))}
            ...
            <li key={course.id}>
              ...
              <div className="buttu">
                <img
                  src={Delete}
                  className={course.id}
                  onClick={(e) => onRemove(e.target.className)}
                />
              </div>
            </li>
          ))}
